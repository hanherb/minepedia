<template lang="pug">
  <d-container fluid class="main-content-container px-4 pb-4">
    ...
    <d-button class="btn-white" id="hargaPokok" v-on:click="toggleTable($event.currentTarget.id)">Harga Pokok Penjualan</d-button>
    <v-client-table class="dataTables_wrapper hargaPokok" :data="hargaPokok.tableData" :columns="hargaPokok.columns" :options="hargaPokok.clientTableOptions">
    </v-client-table>
