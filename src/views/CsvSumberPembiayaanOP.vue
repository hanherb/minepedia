  ...
  div( class="container")
    div( class="panel panel-sm")
      div( class="panel-heading")
        h4 Import Spreadsheet Sumber Pembiayaan
      div( class="panel-body")
        ...
        d-container( fluid class="main-content-container px-4 pb-4")
          ...
          div( align='center' v-if="tableData[0]")
            d-button( theme="primary" v-on:click="addSumberPembiayaan") Submit
</template>
...
export default {
  ...
  methods: {
    ...
    addSumberPembiayaan() {
      ...
      .then((response) => {
        location.reload();
        alert("Add Sumber Pembiayaan Success");
      });
    }
  }
};
